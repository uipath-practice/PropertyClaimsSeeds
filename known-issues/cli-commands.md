...
## `uip solution deploy list` returned 403 — on 1.199; it works on 1.201

It answered `Forbidden (403) — errorCode: "0004"` for a whole round while the same account could deploy. On the 1.201 line it lists deployments. If it refuses again, `uip or processes list --folder-key <key>` shows what landed.
