...
table, the six processes the exercise provides, and the review task the two human gateways raise. They live here rather than inside a block folder because two or three blocks each read them, and a
